...
class database{
	...
	function input($nama,$alamat,$usia){
		mysqli_query($this->conek,"INSERT INTO user(nama,alamat,usia) values ('$nama','$alamat','$usia')");
	...
	function update($id,$nama,$alamat,$usia){
		mysqli_query($this->conek, "UPDATE user SET nama='$nama', alamat='$alamat', usia='$usia' where id= '$id' ");
